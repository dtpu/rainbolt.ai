  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-hidden border-t border-white/10">
        ...
        <div
          className="overflow-y-auto px-4 space-y-3 pb-6"
          style={{ maxHeight: "calc(80vh - 320px)" }}
        >
          {isLoadingImages ? (
            ...
            images.map((imageUrl, index) => (
              <div
                key={index}
                className="relative rounded-lg overflow-hidden bg-black/50 border border-white/10 hover:border-blue-400/50 transition-all group"
              >
                <img
                  src={imageUrl}
